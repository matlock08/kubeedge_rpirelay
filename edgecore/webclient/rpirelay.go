...
func getRelayState(client dynamic.Interface, deviceName string) (string, string, string, string) {
	...
	for _, device := range devices.Items {
		...
		ch1Value := twins.([]interface{})[0].(map[string]interface{})["reported"].(map[string]interface{})["value"].(string)
		ch2Value := twins.([]interface{})[1].(map[string]interface{})["reported"].(map[string]interface{})["value"].(string)
		ch3Value := twins.([]interface{})[2].(map[string]interface{})["reported"].(map[string]interface{})["value"].(string)
